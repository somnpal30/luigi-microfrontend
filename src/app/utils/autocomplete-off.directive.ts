...
export class AutocompleteOffDirective {
    constructor(private _el: ElementRef) {
        //console.log(this._el.nativeElement.getAttribute('name'))
        /*this._el.nativeElement.setAttribute('name',
            this._el.nativeElement.getAttribute('name'));*/
        this._el.nativeElement.setAttribute("id",this._el.nativeElement.getAttribute('name'))
